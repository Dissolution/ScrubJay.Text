...
//     {
//         _text.AddMany(_whitespace.NewLine.AsSpan());
//         _text.AddMany(_whitespace.CurrentIndent);
//         return _builder;
//     }
//
...
//         var i = _text.TryFindIndex(_whitespace.NewLine.AsSpan(), firstToLast: false);
//         if (i.HasSome(out var index))
//         {
//             var newIndent = _text.Written.Slice(index + _whitespace.NewLine.Length);
